...
public class BitmapHelper {
    ...
    private static final String TAG = LogUtil.makeLogTag(BitmapHelper.class);
    ...
    public static Bitmap fetchAndRescaleBitmap(String uri, int width, int height)
        ...
        try {
            ...
            LogUtil.d(TAG, "Scaling bitmap ", uri, " by factor ", scaleFactor, " to support ", width, "x", height, "requested dimension");
            is.reset();
