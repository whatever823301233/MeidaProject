...
import com.qiang.meidaproject.activity.base.ActionBarCastActivity;
...
public class FullScreenPlayerActivity extends ActionBarCastActivity {
    ...
    private static final String TAG = LogUtil.makeLogTag(FullScreenPlayerActivity.class);
    ...
    private final MediaController.Callback mCallback = new MediaController.Callback() {
        ...
        public void onPlaybackStateChanged(@NonNull PlaybackState state) {
            LogUtil.d(TAG, "onPlaybackstate changed", state);
