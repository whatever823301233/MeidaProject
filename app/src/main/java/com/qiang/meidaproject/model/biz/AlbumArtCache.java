package com.qiang.meidaproject.model.biz;

import android.graphics.Bitmap;
import android.os.AsyncTask;
import android.util.LruCache;

import com.qiang.meidaproject.common.utils.BitmapHelper;
    ...
    public void fetch(final String artUrl, final FetchListener listener) {
        ...
        new AsyncTask<Void, Void, Bitmap[]>() {
            ...
            protected Bitmap[] doInBackground(Void[] objects) {
                ...
                LogUtil.d(TAG, "doInBackground: putting bitmap in cache. cache size=" + mCache.size());
                return bitmaps;
            }
            ...
            protected void onPostExecute(Bitmap[] bitmaps) {
                if (bitmaps == null) {
                    ...
                    listener.onFetched(
                            artUrl,
                            bitmaps[BIG_BITMAP_INDEX],
                            bitmaps[ICON_BITMAP_INDEX]);
                }
            }
        }.execute();
    }
